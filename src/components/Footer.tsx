        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-muted-foreground mb-4">
              Master coding challenges and become the developer you aspire to be.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/dashboard" className="text-muted-foreground hover:text-foreground transition-colors">Challenges</Link></li>
